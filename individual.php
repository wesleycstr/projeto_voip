            ...
            <table class="table">
                ...
                <?php
                    if(isset($_POST['atualizar'])){
                        ...
                        header("location:./individual.php?matricula=$matricula");
                        informar_meta($matricula);
                    }
                    ...
                    while ($row_registro = mysqli_fetch_assoc($resultado)){
                        ...
                        echo "<tr>";
                        echo "<td>$matricula</td><td>$nome</td><td><input type='input' size='2' name='valor' value='$meta_atual' maxlength='3'></td><td>$meta_anterior</td><td>   $valor_atual</td><td><button type='submit' name='atualizar' value='$matricula' action='' class='btn btn-primary m-2'>ATUALIZAR</button></td>";
                        echo "</tr>";
                        echo "</form>";
                    }
/*INICIO Funcao para gerar uma chamada e acionar AGI que informa a mudanca de meta*/ 

function informar_meta($matricula){

$ArquivoCall = "informa_meta-$matricula.call";

//Geracao de arquivo.call chamando a AGI autenticacao.call
$frase = "Channel: SIP/$matricula
CallerID: 'Central de metas' <777>
MaxRetries: 0
RetryTime: 300
WaitTime: 45
Application: AGI
Data: informe-meta.agi,$matricula
Archive: yes
";
...
/*FIM Funcao para gerar uma chamada e acionar AGI que informa a mudanca de meta*/
                ?>
